    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="adminlogin.php" class="sign-up-form" method="post">
                    ...
                    <input type="submit" class="btn" value="Login" onclicked="forgotpass.html">
                </form>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="employee.png" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="admin.png" class="image" alt="" />
            </div>
        </div>
    </div>
